...
// NewUpdateReceptionParams creates a new UpdateReceptionParams object
// no default values defined in spec.
func NewUpdateReceptionParams() UpdateReceptionParams {

	return UpdateReceptionParams{}
}

// UpdateReceptionParams contains all the bound params for the update reception operation
// typically these are obtained from a http.Request
//
// swagger:parameters updateReception
...
//
// To ensure default values, the struct must have been initialized with NewUpdateReceptionParams() beforehand.
func (o *UpdateReceptionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		...
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				...
				res = append(res, errors.NewParseError("participant", "body", "", err))
			}
		} else {
...
func (o *UpdateReceptionParams) bindXSPLATHONAPITOKEN(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *UpdateReceptionParams) bindEventID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
