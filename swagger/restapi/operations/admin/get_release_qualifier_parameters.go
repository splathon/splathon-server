...
// NewGetReleaseQualifierParams creates a new GetReleaseQualifierParams object
// no default values defined in spec.
func NewGetReleaseQualifierParams() GetReleaseQualifierParams {

	return GetReleaseQualifierParams{}
}

// GetReleaseQualifierParams contains all the bound params for the get release qualifier operation
// typically these are obtained from a http.Request
//
// swagger:parameters getReleaseQualifier
type GetReleaseQualifierParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewGetReleaseQualifierParams() beforehand.
func (o *GetReleaseQualifierParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetReleaseQualifierParams) bindEventID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
