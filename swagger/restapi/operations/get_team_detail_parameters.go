...
//
// To ensure default values, the struct must have been initialized with NewGetTeamDetailParams() beforehand.
...
func (o *GetTeamDetailParams) bindEventID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
