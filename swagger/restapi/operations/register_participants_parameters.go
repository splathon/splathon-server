...
// NewRegisterParticipantsParams creates a new RegisterParticipantsParams object
// no default values defined in spec.
func NewRegisterParticipantsParams() RegisterParticipantsParams {

	return RegisterParticipantsParams{}
}

// RegisterParticipantsParams contains all the bound params for the register participants operation
// typically these are obtained from a http.Request
//
// swagger:parameters registerParticipants
type RegisterParticipantsParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewRegisterParticipantsParams() beforehand.
func (o *RegisterParticipantsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *RegisterParticipantsParams) bindXSPLATHONAPITOKEN(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *RegisterParticipantsParams) bindEventID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *RegisterParticipantsParams) bindSplathonReceptionCode(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
