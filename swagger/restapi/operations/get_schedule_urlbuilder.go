...
func (o *GetScheduleURL) Build() (*url.URL, error) {
	...
	if eventID != "" {
		...
		return nil, errors.New("eventId is required on GetScheduleURL")
	}
...
func (o *GetScheduleURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetScheduleURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetScheduleURL")
	}
