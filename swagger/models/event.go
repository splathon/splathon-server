...
func (m *Event) validateNumbering(formats strfmt.Registry) error {
...
func (m *Event) validateRules(formats strfmt.Registry) error {
...
func (m *Event) validateStages(formats strfmt.Registry) error {
